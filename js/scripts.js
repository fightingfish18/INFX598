$(function() {
	//Array of stopwords.  To be excluded.
	...
	//Set up click event on the submit button to analyze provided text.
	...
	//Put the words used a specified number of times into the wordList
	...
	//Calls the thesaurus API to find synonyms
	//NOTE: We do not vouch for the accuracy of these synonyms, they are provided by a 3rd party
	...
	//Creates a graph on the submitted text analysis.
	//Graph data is based off the top 10 Porter stems present
	//The graph is 1200x600
	function graph(data) {
